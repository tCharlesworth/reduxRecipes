...
class GroupsHome extends Component {
  ...
  onPressCreate() {
    this.props.goToPage('GroupCreate');
  }
  renderNoGroups() {
    return (
      <View style={{alignItems: 'center', paddingTop: 60}}>
        ...
        <View style={{flexDirection: 'row'}}>
          ...
          <TextButton onPress={this.onPressCreate.bind(this)} styles={{fontSize: 20, color: 'blue'}}>create</TextButton><Text style={{fontSize: 20}}> one!</Text>
        </View>
      </View>
    )
  }
